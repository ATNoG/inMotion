...
\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{\begin{tabular}{@{}lll@{}}\toprule
            ...
            MetaFusion                        & Context-aware      & LSTM/GRU fused with learned vector representations (dim~8) of noise flag and concurrent interference path
            Multi-Scale CNN                     & Multi-branch       & Kernels $(3,5,7)$ + residual + attention              \\
            SoftMoE                           & Mixture of Experts & Heterogeneous experts, learned top-2 gating routing inputs to best experts
