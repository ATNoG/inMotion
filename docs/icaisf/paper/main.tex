...
\begin{document}
\title{Deep Learning for RSSI-Based Passenger Movement Classification in Public Transport}


\author{
\IEEEauthorblockN{Guilherme Matos}
\IEEEauthorblockA{\textit{Instituto de Telecomunica\c{c}\~{o}es} \\
\textit{Universidade de Aveiro}\\
Aveiro, Portugal \\
gui.matos@av.it.pt}
\and
\IEEEauthorblockN{Andr\'{e} Ribeiro}
\IEEEauthorblockA{\textit{Instituto de Telecomunica\c{c}\~{o}es} \\
\textit{Universidade de Aveiro}\\
Aveiro, Portugal \\
andrepedroribeiro@av.it.pt}
\and
\IEEEauthorblockN{Julio Corona}
\IEEEauthorblockA{\textit{Instituto de Telecomunica\c{c}\~{o}es} \\
\textit{Universidade de Aveiro}\\
Aveiro, Portugal \\
jcamejo@av.it.pt}
\and
\IEEEauthorblockN{M\'{a}rio Antunes}
\IEEEauthorblockA{\textit{Instituto de Telecomunica\c{c}\~{o}es \& DETI} \\
\textit{Universidade de Aveiro}\\
Aveiro, Portugal \\
mario.antunes@av.it.pt, mario.antunes@ua.pt}
\and
\IEEEauthorblockN{Diogo Gomes}
\IEEEauthorblockA{\textit{Instituto de Telecomunica\c{c}\~{o}es \& DETI} \\
\textit{Universidade de Aveiro}\\
Aveiro, Portugal \\
