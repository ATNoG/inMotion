...
The reviewed literature demonstrates significant progress, yet gaps remain. Vision-based systems raise privacy concerns and face deployment challenges. CSI-based WiFi sensing requires specialized equipment. RSSI-based approaches provide a middle ground, though most work focuses on static counting rather than movement pattern classification. Our work addresses this gap by developing an RSSI-based approach specifically designed to classify passenger movements through temporal pattern analysis, complementing existing counting methods while maintaining accessibility and privacy benefits.