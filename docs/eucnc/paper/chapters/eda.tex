...
To further inspect the structure of the 10-dimensional \ac{RSSI} feature vectors, a \ac{t-SNE} projection was applied for visualization purposes. The resulting two-dimensional embedding, shown in \autoref{fig:tsne}, reveals the formation of four predominantly distinct clusters corresponding to the defined movement classes.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{images/tsne_visualization.pdf}
    \caption{\ac{t-SNE} projection for visualization of each class structure}
    \label{fig:tsne}
\end{figure}

Although partial overlap is evident, mainly among samples collected under noisy conditions, the overall clustering suggests that temporal \ac{RSSI} patterns retain sufficient class-dependent structure to support supervised learning approaches. This analysis serves as a qualitative inspection of feature separability rather than a quantitative performance evaluation.