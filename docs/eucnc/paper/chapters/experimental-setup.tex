...
\textbf{Isolated-Only Dataset:} A subset containing exclusively samples collected under isolated conditions (single device, $n = 159$). This scenario provides an upper-bound estimate of classification performance under ideal conditions with minimal signal interference.
...
The comparison across these scenarios enables quantitative assessment of how environmental noise affects classification accuracy and provides insights into the operational boundaries of RSSI-based movement detection.
